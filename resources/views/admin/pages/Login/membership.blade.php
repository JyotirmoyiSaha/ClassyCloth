                    ...
                    <div class="card-wrapper card1">
                        <div class="card-box align-left">
                            ...
                            <p class="card-text mbr-fonts-style display-7">Lorem ipsum dolor sit amet, consectetur adipiscing
                                elit.</p>
                            <h6 class="link mbr-fonts-style display-4"><a href="{{route('get.membership','free')}}" class="text-info">Free</a></h6>
                        </div>
                    </div>
                </div>
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper card2">
                        <div class="card-box align-left">
                            ...
                            <h6 class="link mbr-fonts-style display-4"><a href="{{route('get.membership','premium')}}" class="text-info">$100</a></h6>
                        </div>
                    </div>
                </div>
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper card3">
                        <div class="card-box align-left">
                            ...
                            <p class="card-text mbr-fonts-style display-7">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                            <h6 class="link mbr-fonts-style display-4"><a href="{{route('get.membership','pro')}}" class="text-info">$150</a></h6>
                        </div>
                    </div>
                </div>
